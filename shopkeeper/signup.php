...
$sql = "SELECT * FROM storemanager WHERE email='$email' LIMIT 1";
...
if ($result->num_rows > 0) {
  ...
  if (count($errors) == 0) {
    ...
    $stmt = $conn->prepare("INSERT INTO storemanager (user,pass,email,mobile,token) VALUES (?,?,?,?,?)");
                    ...
                    <div class="card card-signin flex-row my-5">
                      ...
                      <div class="card-body">
                        ...
                        <?php include('errors.php'); ?>
                          ...
                          <div class="my-2 ml-2 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1" required>
                            <label class="form-check-label" for="exampleCheck1"><a href="" data-toggle="modal" data-target="#exampleModal">Terms and Conditions</a></label>
                          </div>
                          <!-- Modal -->
